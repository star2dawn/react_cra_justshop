...
function WrapComponent(){
  ...
  // 모달 부모 컴포넌트에서 
  // 상태 변경 함수를 만든다
  // 그리고 자식 컴포넌트에서 프롭스로 함수 내려주고
  // 자식 컴포넌트에서 버튼 클릭 이벤트로 상태변경함수를 실행, 그러면 변경
...
// 프롭스를 중괄호를 사용 직접 비구조화
// 2. function HeaderComponent({homePath,logoTitle,imgSrc,imgAlt}){
...
//  상태관리 변수 addClass 를 마우스가 클릭하면 true로 상태 변경
//  const onClickAddClass=(e)=>{
//    e.preventDefault();
//    alert('클릭');
//    setAddClass(true); // 상태변경
//  }
//  상태관리 변수 addClass를 마우스가 클릭하면 false로 상태 변경
  ...
  return(
      ...
      return(
        <section id="section2">
          ...
          <div className="center">
            <div className="title"><h2 style={{color:'rgb(95,0,128)', fontSize:'16px', fontWeight:'500'}}>BANNER LINK</h2></div>
            <div className="img-box">
              <a href="#" title="banner"><img src="./images/banner.jpg" alt=""/></a>
            </div>
          </div>
          <div className="right">
            <div className="title"><h2 style={{color:'rgb(95,0,128)', fontSize:'16px', fontWeight:'500'}}>DIRECT LINK</h2></div>
            <div className="img-box">
    ...
    Section2Component.defaultProps = {
      notice: [
        ...
        {공지글목록:"반품/환불 규정에 대해 알려드립니다",날짜:"2020.11.12"},
        {공지글목록:"3월 재입고 품목을 알려드립니다",날짜:"2020.10.28"},
      ],
      gallery: [
  ...
  return(
    <footer id="footer">
      ...
      <div className="right">
        ...
        <span><a href="#" title="트위터"><img src="./images/sns2.jpg" alt=""/></a></span>
...
// 2. 리액돔은 루트 돔 컨테이너와 컴포넌트(WrapComponent) 연동시킨다.
